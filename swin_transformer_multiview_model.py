"""
CBIS-DDSM Multi-View Swin Transformer Model

Binary classification using multi-view mammography images with Swin Transformer.
Aggregates features from multiple views per patient for final classification.
...
OUTPUT_RESULTS_DIR = r"d:\Allen Archive\Allen Archives\NEU_academics\Semester4\ML\Project\CBIS_DDSM_Model_Comparison\results\swin_transformer_multiview"
...
class MetricsCalculator:
    ...
    def print_metrics(metrics, phase='Test'):
        print(f"\n{phase} Metrics - Multi-View Swin Transformer:")
...
class Visualizer:
    ...
    def plot_confusion_matrix(y_true, y_pred, output_path):
        ...
        plt.title('Confusion Matrix - Multi-View Swin Transformer', fontsize=14, fontweight='bold')
    ...
    def plot_roc_curve(y_true, y_pred_proba, output_path):
        ...
        plt.title('ROC Curve - Multi-View Swin Transformer', fontsize=14, fontweight='bold')
    ...
    def plot_pr_curve(y_true, y_pred_proba, output_path):
        ...
        plt.title('Precision-Recall Curve - Multi-View Swin Transformer', fontsize=14, fontweight='bold')
...
class Trainer:
    ...
    def train(self, num_epochs):
        ...
        print("\nStarting Multi-View Swin Transformer training")
        ...
        for epoch in range(num_epochs):
            ...
            if val_loss < self.best_val_loss:
                ...
                best_model_path = os.path.join(OUTPUT_MODEL_DIR, 'swin_transformer_multiview_best.pth')
...
def main():
    print("\nMulti-View Swin Transformer Model Training")
    print("-" * 40)
    ...
    # Initialize model
    print(f"\nInitializing Multi-View {MODEL_NAME}...")
