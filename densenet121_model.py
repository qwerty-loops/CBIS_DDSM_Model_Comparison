"""
CBIS-DDSM DenseNet121 Model

Binary classification of mammography images using DenseNet121 architecture.
...
class Visualizer:
    ...
    def plot_pr_curve(y_true, y_pred_proba, output_path):
        ...
        plt.title('Precision-Recall Curve - DenseNet121', fontsize=14, fontweight='bold')
    ...
    def plot_training_history(train_losses, val_losses, train_accs, val_accs, output_path):
        ...
        # Loss plot
        ax1.plot(train_losses, label='Train Loss', marker='o', color='green')
        ax1.plot(val_losses, label='Validation Loss', marker='s', color='darkgreen')
        ...
        ax2.plot(val_accs, label='Validation Accuracy', marker='s', color='darkgreen')
    ...
    def train(self, num_epochs):
        ...
        for epoch in range(num_epochs):
            ...
            if val_loss < self.best_val_loss:
                ...
                best_model_path = os.path.join(OUTPUT_MODEL_DIR, 'densenet121_best.pth')
