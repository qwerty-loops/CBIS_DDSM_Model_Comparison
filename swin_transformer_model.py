"""
CBIS-DDSM Swin Transformer Model

Binary classification of mammography images using Swin Transformer architecture.
...
OUTPUT_RESULTS_DIR = r"d:\Allen Archive\Allen Archives\NEU_academics\Semester4\ML\Project\CBIS_DDSM_Model_Comparison\results\swin_transformer"
...
class MetricsCalculator:
    ...
    def print_metrics(metrics, phase='Test'):
        print(f"\n{phase} Metrics - Swin Transformer:")
...
class Visualizer:
    ...
    def plot_confusion_matrix(y_true, y_pred, output_path):
        ...
        plt.title('Confusion Matrix - Swin Transformer', fontsize=14, fontweight='bold')
    ...
    def plot_roc_curve(y_true, y_pred_proba, output_path):
        ...
        plt.title('ROC Curve - Swin Transformer', fontsize=14, fontweight='bold')
    ...
    def plot_pr_curve(y_true, y_pred_proba, output_path):
        ...
        plt.title('Precision-Recall Curve - Swin Transformer', fontsize=14, fontweight='bold')
    ...
    def train(self, num_epochs):
        ...
        for epoch in range(num_epochs):
            ...
            if val_loss < self.best_val_loss:
                ...
                best_model_path = os.path.join(OUTPUT_MODEL_DIR, 'swin_transformer_best.pth')
