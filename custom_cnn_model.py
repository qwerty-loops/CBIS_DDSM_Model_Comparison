...
IMAGE_SIZE = 224 # Or whatever size you prefer for custom, 224 is standard
BATCH_SIZE = 16
NUM_EPOCHS = 30
LEARNING_RATE = 1e-4
NUM_CLASSES = 2
...
OUTPUT_RESULTS_DIR = r"d:\Allen Archive\Allen Archives\NEU_academics\Semester4\ML\Project\CBIS_DDSM_Model_Comparison\results\custom_cnn"
